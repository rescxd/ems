import installerImage from '@/assets/pages/home/forWhom/type1Image.png';
import Image from 'next/image';

const Installers = () => {
    const BenefitItems = [
        'Zgodność z wymogami NFOŚiGW dla systemów HEMS/EMS',
        'Centralny panel do zdalnego zarządzania instalacjami klientów',
    ];
    return (
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-[40px] md:gap-[60px] 2xl:gap-[80px]">
                <div className="flex flex-col justify-center gap-[20px]">
                    ...
                    <p className="text-[#262626CC] text-[clamp(14px,2vw,17px)] font-normal leading-[28px] xl:leading-[34px] tracking-[0.17px]">
                        EMS HOUSE pozwala firmom instalacyjnym oferować system
                        zgodny z wymogami Mój Prąd. Gotowa platforma z funkcją
                        ograniczania eksportu skraca czas wdrożenia i buduje
                        zaufanie klientów szukających sprawdzonych rozwiązań.
                    </p>
