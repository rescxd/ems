import installerImage from '@/assets/pages/home/forWhom/type2Image.png';
import Image from 'next/image';

const Wholesale = () => {
    const BenefitItems = [
        'Gotowy produkt spełniający wymogi programu Mój Prąd',
        'Pełne wsparcie techniczne i materiały szkoleniowe w języku polskim',
    ];
    return (
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-[40px] md:gap-[60px] 2xl:gap-[80px]">
                <div className="flex flex-col justify-center gap-[20px]">
                    ...
                    <p className="text-[#262626CC] text-[clamp(14px,2vw,17px)] font-normal leading-[28px] xl:leading-[34px] tracking-[0.17px]">
                        Hurtownie PV mogą rozszerzyć ofertę o kompletny system
                        EMS zgodny z programem Mój Prąd. Polskie wsparcie
                        techniczne i dokumentacja w języku polskim zapewniają
                        przewagę nad importowanymi produktami bez lokalnego
                        zaplecza.
                    </p>
